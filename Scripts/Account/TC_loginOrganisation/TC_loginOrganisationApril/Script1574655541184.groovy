...
var_enciphered_password = SecureUtils.doEncryptPinRsaEwallet(GlobalVariable.dev_public_pem_file, GlobalVariable.login_merchant_password)

String plain =
'{'+
'"user_agent":"'+ GlobalVariable.user_agent + '",' +
'"email_address":"'+ GlobalVariable.login_merchant_email + '",'+
'"password":"' + var_enciphered_password +
'"}'

partner_token = GlobalVariable.partner_token
...
def request = (RequestObject) findTestObject('Account/obj_loginOrganisation')
