...
//var_phone_number = findTestData("Account/DF_signUpMerchant").getValue("phone_number", 1)
//var_email_address = findTestData("Account/DF_signUpMerchant").getValue("email_address", 1)
//var_fullname = findTestData("Account/DF_signUpMerchant").getValue("fullname", 1)
//var_organisation_id = findTestData("Account/DF_signUpMerchant").getValue("organisation_id", 1)
//var_lang = findTestData("Account/DF_signUpMerchant").getValue("lang", 1)
//var_expected_rc = findTestData("Account/DF_signUpMerchant").getValue("expected_rc", 1)
