...
//encrpyt the pin
var_enciphered_password = SecureUtils.doEncryptPinRsaEwallet(GlobalVariable.dev_public_pem_file, var_user_password)
var_enciphered_new_password = SecureUtils.doEncryptPinRsaEwallet(GlobalVariable.dev_public_pem_file, var_user_new_password)
var_enciphered_confirm_new_password = SecureUtils.doEncryptPinRsaEwallet(GlobalVariable.dev_public_pem_file, var_user_confirm_new_password)
String plain =
'{'+
'"old_password":"'+ var_enciphered_password + '",' +
'"new_password":"'+ var_enciphered_new_password + '",'+
'"confirm_password":"'+ var_enciphered_confirm_new_password +
'"}'
...
def request = (RequestObject) findTestObject('Account/obj_changePasswordMerchant')
