...
//var_user_agent = findTestData("Account/DF_checkAccount").getValue("user_agent", 1)
//var_phone_number = findTestData("Account/DF_checkAccount").getValue("phone_number", 1)
//var_organisation_id = findTestData("Account/DF_checkAccount").getValue("organisation_id", 1)
//var_lang = findTestData("Account/DF_checkAccount").getValue("lang", 1)
//var_expected_rc = findTestData("Account/DF_checkAccount").getValue("expected_rc", 1)
//var_customer_token = findTestData("Account/DF_checkAccount").getValue("customer_token", 1)
...
def request = (RequestObject) findTestObject('Account/obj_checkAccount')
