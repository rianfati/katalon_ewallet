...
//String plain =('{"user_agent": "'+ var_user_agent +'","data_rules":{"filter": {"enrolment_id":"'+var_enrollment_id+'"}}}')
String plain = ('{"data_rules":{"filter":{"start_created_date":"'+var_start_created_date+'","end_created_date":"'+var_end_created_date+'","enrolment_type":"'+var_enrolment_type+'","enrolment_id": "'+var_enrolment_id+'"},"search":{},"sort":[]},"user_agent":"'+var_user_agent+'"}')
//String plain = '{"user_agent": "1", "data_rules": {"filter":{"enrolment_id":"1"}}}'
...
def request = (RequestObject) findTestObject('Dashboard_App/obj_getTempEnrollmentList')
