...
String plain = '{"user_agent": "'+var_user_agent+'", "data_rules": {"filter": {"billing_status":"'+var_billing_status+'", "issuer_code":"'+var_issuer_id+'", "start_date":"'+var_start_date+'","end_date":"'+var_end_date+'"}, "search": {"billing_id": "'+var_billing_id+'"}, "sort": ["amount"]}}'
