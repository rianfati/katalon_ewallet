...
'","data_rules": {"filter": {"implementor_id": "'+ var_implementor_id +
'"},"search" : {"employee_name": "'+ var_employee_name +
'"}}}'
...
def request = (RequestObject) findTestObject('Dashboard_App/obj_getImplementorList')
