...
String plain =
'{'+
'"settlement_name":"'+ var_settlement_name + '",' +
'"total_amount":"' + var_total_amount +'",'+
'"fee_amount":"'+ var_fee_amount + '",' +
'"for_merchant_id":"'+ var_for_merchant_id + '",'+
'"transactions":['+ var_transactions +'],"currency":"' + var_currency + 
'"}'
...
def request = (RequestObject) findTestObject('Dashboard_App/obj_createSettlement')
