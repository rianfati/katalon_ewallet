...
String plain = '{"user_agent": "'+var_user_agent+'", "data_rules": {"filter": {}, "search": {"journal_number": "'+var_journal_number+'", "transaction_date": "'+var_transaction_date+'", "trx_type_name": "'+var_trx_type_name+'"}, "sort": ["journal_number", "transaction_datetime", "trx_name", "transaction_amount", "total_fee", "net_amount"]}}'
