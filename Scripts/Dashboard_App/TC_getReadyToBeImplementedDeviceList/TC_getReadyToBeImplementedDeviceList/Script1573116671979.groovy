...
'","data_rules": {"filter": {"edc_register_id": "'+ var_edc_register_id +
'"},"search" : {"imei": "'+ var_imei +
...
def request = (RequestObject) findTestObject('Dashboard_App/obj_getReadyToBeImplementedDeviceList')
