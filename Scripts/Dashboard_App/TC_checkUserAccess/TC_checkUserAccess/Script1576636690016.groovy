...
'"user_role_id":"'+ var_user_role_id + '",' +
'"component_type":"'+ var_component_type + '",' +
'"content_id":"' + var_content_id +
'"}'
...
def request = (RequestObject) findTestObject('Dashboard_App/obj_checkUserAccess')
