...
String plain = '{"user_agent": "'+var_user_agent+'", "data_rules": {"filter": {}, "search": {"journal_number": "'+var_journal_number+'", "transaction_date": "'+var_transaction_date+'", "trx_type_name": "'+var_trx_type_name+'"}}}'

GlobalVariable.page_number = var_page_number
GlobalVariable.page_size = var_page_size
GlobalVariable.settlement_detil_id = var_settlement_detil_id
...
println (GlobalVariable.settlement_detil_id)
...
def request = (RequestObject) findTestObject('Dashboard_App/obj_getSettlementDetil')
