...
File file = new File("./resources/rakhmat/"+var_file+"")
println(file)
...
'","upload_type":"'+ var_upload_type +
'","enrolment_id":"'+ var_enrolment_id +
'","r_outlet_id":"'+ var_r_outlet_id +
'","file_name":"'+ var_file_name +
'","file":"'+ basse64 +
'","document_type":"'+ var_document_type+
'"}'
...
def request = (RequestObject) findTestObject('Dashboard_App/obj_uploadDocument')
