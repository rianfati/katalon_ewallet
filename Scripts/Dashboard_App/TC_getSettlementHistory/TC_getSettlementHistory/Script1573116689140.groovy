...
'","data_rules": {"filter": {"org_id": "'+ var_org_id +
'","start_date": "'+ var_start_date +
'","end_date": "'+ var_end_date +
'","approval_status": "'+ var_approval_status +
'","approval_date": "'+ var_approval_date +
'","settlement_id": "'+ var_settlement_id +
'"},"search": {"merchant_name": "'+ var_merchant_name +
'"}}}'
...
def request = (RequestObject) findTestObject('Dashboard_App/obj_getSettlementHistory')
