...
'","enrolment_id": "'+ var_enrolment_id +
'","mops_id": "'+ var_mops_id +
'","sales_id": "'+ var_sales_id +
'","enrolment_status": "'+ var_enrolment_status +
'","enrolment_agreement_status": "'+ var_enrolment_agreement_status +
'","enrolment_payment_status": "'+ var_enrolment_payment_status +
'","enrolment_files_verification": [' + var_enrolment_files_verification +
']}'
...
def request = (RequestObject) findTestObject('Dashboard_App/obj_updateMerchantEnrollmentDetail')
