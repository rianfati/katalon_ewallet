...
int trace_numbera;
trace_numbera = ((Math.random() * 10000) as int)
int trace_numberb;
trace_numberb = ((Math.random() * 10000) as int)

String plain =
'{'+
'"user_agent":"' + var_user_agent +
'","imei":"'+ var_imei +''+trace_numbera+
'","token_code":"'+ var_token_code+''+trace_numberb+
'"}'
...
def request = (RequestObject) findTestObject('Dashboard_App/obj_addRegyt')
