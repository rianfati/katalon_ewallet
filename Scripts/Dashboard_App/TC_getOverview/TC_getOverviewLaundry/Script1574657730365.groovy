...
//var_user_agent = findTestData("Dashboard_App/DF_getOverview/DF_getOverviewLaundry").getValue("user_agent", 1)
//var_expected_rc = findTestData("Dashboard_App/DF_getOverview/DF_getOverviewLaundry").getValue("expected_rc", 1)
//var_customer_token = findTestData("Dashboard_App/DF_getOverview/DF_getOverviewLaundry").getValue("customer_token", 1)
...
def request = (RequestObject) findTestObject('Dashboard_App/obj_getOverviewLaundry')
