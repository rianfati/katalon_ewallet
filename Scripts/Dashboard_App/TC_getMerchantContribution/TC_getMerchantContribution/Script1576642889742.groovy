...
String plain = '{"user_agent": "'+var_user_agent+'", "sort_by": ["transaction_amount", "total_transaction"]}'
String date = var_date
...
def request = (RequestObject) findTestObject('Dashboard_App/obj_getMerchantContribution')
