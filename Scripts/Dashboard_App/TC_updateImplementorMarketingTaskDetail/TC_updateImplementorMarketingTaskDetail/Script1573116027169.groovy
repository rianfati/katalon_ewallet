...
'"mkt_id":"'+ var_mkt_id + '",' +
'"imp_id":"'+ var_imp_id + '",' +
'"marketing_task_status":"'+ var_marketing_task_status + '",' +
'"implementor_task_status":"'+ var_implementor_task_status + '",' +
'"marketing_schema_id":"'+ var_marketing_schema_id + '",' +
//'"device_amount":"'+ var_device_amount + '",' +
'"devices":['+ var_devices +'],' +
'"marketing_kit_items":[' + var_marketing_kit_items +
']}'
...
def request = (RequestObject) findTestObject('Dashboard_App/obj_updateImplementorMarketingTaskDetail')
