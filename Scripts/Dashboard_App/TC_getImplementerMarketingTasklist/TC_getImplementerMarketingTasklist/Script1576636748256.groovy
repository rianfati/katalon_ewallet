...
'","data_rules":{"filter": {"start_created_date": "' + var_start_created_date +
'","end_created_date": "' + var_end_created_date +
'","status": "' + var_status +
'"},"search": {"task_id": "' + var_task_id +
'"},"sort": [""]}}'
...
def request = (RequestObject) findTestObject('Dashboard_App/obj_getImplementerMarketingTasklist')
