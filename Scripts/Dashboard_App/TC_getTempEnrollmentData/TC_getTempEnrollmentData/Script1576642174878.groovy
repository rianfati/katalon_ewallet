...
String plain = ('{"data_rules":{"filter":{"enrolment_id":"'+var_enrolment_id+'"}},"user_agent":"'+var_user_agent+'"}')
...
def request = (RequestObject) findTestObject('Dashboard_App/obj_getTempEnrollmentData')
