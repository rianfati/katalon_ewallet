...
String plain = 
'{"user_agent": "'+var_user_agent+'", "sort_by": ["transaction_amount", "total_transaction"]}'

GlobalVariable.date = var_date
...
def request = (RequestObject) findTestObject('Dashboard_App/obj_getIssuerContribution')
