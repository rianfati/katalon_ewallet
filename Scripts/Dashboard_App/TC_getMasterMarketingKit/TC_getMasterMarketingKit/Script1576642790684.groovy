...
'","data_rules":{'+
	'"search":{'+
		'"marketing_kit_schema_id":"'+var_marketing_kit_schema_id+
		'","merchant_name":"'+var_merchant_name+
		'"},'+
	'"sort":[]'+
		'}'+
'}'
...
def request = (RequestObject) findTestObject('Dashboard_App/obj_getMasterMarketingKit')
