...
'"user_id":"' + var_user_id + '",' +
'"status":"' + var_status + '",' +
'"block_reason":"' + var_block_reason + '",' +
'"block_until":"' + var_block_until + '",' +
'"change_reason":"' + var_change_reason +
'"}'
...
def request = (RequestObject) findTestObject('Dashboard_App/obj_changeUserStatus')
...
//	  String decipheredResponseData = SecureUtils.decryptAesEwallet(respDataMap.data, var_aes_key)
