...
'"employee_number":"' + var_employee_number +'",'+
'"start_date":"'+ var_start_date + '",' +
'"end_date":"'+ var_end_date + '",'+
'"due_date":"' + var_due_date +'",'+
'"description":"'+ var_description + '",' +
'"corresponding_name":"'+ var_corresponding_name + '",'+
'"location_address":"'+ var_location_address + '",'+
...
def request = (RequestObject) findTestObject('Dashboard_App/obj_createSalesTask')
