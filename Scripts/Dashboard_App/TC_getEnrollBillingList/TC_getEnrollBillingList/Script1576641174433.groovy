...
String plain = ('{"data_rules":{"filter":{"status":"'+var_status+'","start_created_date":"'+var_start_created_date+'","end_created_date":"'+var_end_created_date+'"},"search":{"merchant_name": "'+var_merchant_name+'"}},"user_agent":"'+var_user_agent+'"}')
...
def request = (RequestObject) findTestObject('Dashboard_App/obj_getEnrollBillingList')
