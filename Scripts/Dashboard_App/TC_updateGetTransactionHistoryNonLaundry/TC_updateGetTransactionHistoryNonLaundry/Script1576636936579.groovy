...
String plain = '{"outlet_id" : "'+var_outlet_id+'", "transaction_date" : "'+var_transaction_date+'"}'
...
def request = (RequestObject) findTestObject('Dashboard_App/obj_updateGetTransactionHistoryNonLaundry')
