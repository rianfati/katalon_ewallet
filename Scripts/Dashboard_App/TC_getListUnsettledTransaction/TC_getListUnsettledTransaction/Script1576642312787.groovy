...
'{"data_rules":'+
'{"filter": {'+ var_org_id +
''+ var_transaction_date1 +
''+ var_Journal_number1 +
''+ var_trx_type_id +
'},"search": {'+ var_journal_number2 +
''+ var_merchant_name +
''+ var_transaction_date2 +
''+ var_trx_type_name +
'},"sort": '+ var_sort +
...
System.out.println("var_customer_token" + var_merchant_token)
...
def request = (RequestObject) findTestObject('Dashboard_App/obj_getListUnsettledTransaction')
