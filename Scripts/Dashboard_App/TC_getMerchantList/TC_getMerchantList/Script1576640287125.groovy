...
String plain = ('{"data_rules":{"search":{"organisation_name": "'+var_organisation_name+'"}},"user_agent":"'+var_user_agent+'"}')
...
def request = (RequestObject) findTestObject('Dashboard_App/obj_getMerchantList')
