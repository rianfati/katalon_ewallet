...
//var_billing_id = findTestData("E_Wallet/DF_postPayment/DF_postPayment").getValue("billing_id", 1)
//var_amount = findTestData("E_Wallet/DF_postPayment/DF_postPayment").getValue("amount", 1)
//var_billing_ref1 = findTestData("E_Wallet/DF_postPayment/DF_postPayment").getValue("billing_ref1", 1)
//var_billing_ref2 = findTestData("E_Wallet/DF_postPayment/DF_postPayment").getValue("billing_ref2", 1)
//var_billing_ref3 = findTestData("E_Wallet/DF_postPayment/DF_postPayment").getValue("billing_ref3", 1)
//var_organisation_id = findTestData("E_Wallet/DF_postPayment/DF_postPayment").getValue("organisation_id", 1)
//var_lang = findTestData("E_Wallet/DF_postPayment/DF_postPayment").getValue("lang", 1)
//var_expected_rc = findTestData("E_Wallet/DF_postPayment/DF_postPayment").getValue("expected_rc", 1)
//var_customer_token = findTestData("E_Wallet/DF_postPayment/DF_postPayment").getValue("customer_token", 1)
...
'"amount":"'+ var_amount + '",'+
'"amount_after_promo":"' + var_amount_after_promo +'",'+
...
'"promo_name":"' + var_promo_name +'",'+
'"promo_type":"' + var_promo_type +'",'+
'"promo_value":"' + var_promo_value +
'"}'
...
def request = (RequestObject) findTestObject('E_Wallet/obj_gamificationUpdateAPIPostPayment')
