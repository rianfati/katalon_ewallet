...
File file = new File("./resources/rakhmat/"+var_template+"")
println(file)
...
def request = (RequestObject) findTestObject('E_Wallet/obj_templateIdentification_svc')
