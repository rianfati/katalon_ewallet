...
//var_user_agent = findTestData("E_Wallet/DF_getSofBalanceFromExternal/DF_getSofBalanceFromExternal").getValue("user_agent", 1)
//var_wallet_id = findTestData("E_Wallet/DF_getSofBalanceFromExternal/DF_getSofBalanceFromExternal").getValue("wallet_id", 1)
//var_organisation_id = findTestData("E_Wallet/DF_getSofBalanceFromExternal/DF_getSofBalanceFromExternal").getValue("organisation_id", 1)
//var_lang = findTestData("E_Wallet/DF_getSofBalanceFromExternal/DF_getSofBalanceFromExternal").getValue("lang", 1)
//var_expected_rc = findTestData("E_Wallet/DF_getSofBalanceFromExternal/DF_getSofBalanceFromExternal").getValue("expected_rc", 1)
//var_customer_token = findTestData("E_Wallet/DF_getSofBalanceFromExternal/DF_getSofBalanceFromExternal").getValue("customer_token", 1)
...
def request = (RequestObject) findTestObject('E_Wallet/obj_updateBalanceFromExternal')
