...
//var_user_agent = findTestData("E_Wallet/DF_EDCActivation/DF_EDCActivation").getValue("var_user_agent", 1)
//var_activation_code = findTestData("E_Wallet/DF_EDCActivation/DF_EDCActivation").getValue("var_activation_code", 1)
//var_token_code = findTestData("E_Wallet/DF_EDCActivation/DF_EDCActivation").getValue("var_token_code", 1)
//var_customer_token = findTestData("E_Wallet/DF_EDCActivation/DF_EDCActivation").getValue("var_customer_token", 1)
//var_expected_rc = findTestData("E_Wallet/DF_EDCActivation/DF_EDCActivation").getValue("var_expected_rc", 1)
...
'"activation_code":"'+ var_activation_code + '",'+
'"token_code":"' + var_token_code +
'"}'
...
def request = (RequestObject) findTestObject('E_Wallet/obj_EDCActivation')
