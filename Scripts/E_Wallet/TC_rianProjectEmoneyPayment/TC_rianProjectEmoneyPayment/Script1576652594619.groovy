...
var_enciphered_pin = SecureUtils.doEncryptPinRsaEwallet(GlobalVariable.dev_public_pem_file, var_pin)
/* First prepare the data */
GlobalVariable.partner_token = var_partner_token
String plain
if (model == '0'){
	plain =   '{"user_agent":"'+GlobalVariable.user_agent+'","billing_id":"'+GlobalVariable.var_billing_id+'","wallet_id":"'+GlobalVariable.wallet_id+'","phone_number":"'+GlobalVariable.login_phone_number+'","authentication":"'+var_enciphered_pin+'"}'
}
else if (model == '1'){
	plain =   '{"user_agent":"'+var_user_agent+'","billing_id":"'+var_billing_id+'","wallet_id":"'+var_wallet_id+'","phone_number":"'+var_phone_number+'","authentication":"'+var_enciphered_pin+'","qr_unique_code":"'+unique_code+'"}'
}
else {
	plain =   '{"user_agent":"'+var_user_agent+'","billing_id":"'+GlobalVariable.var_billing_id+'","wallet_id":"'+var_wallet_id+'","phone_number":"'+var_phone_number+'","authentication":"'+var_enciphered_pin+'"}'
}
...
def request = (RequestObject) findTestObject('E_Wallet/obj_payment')
