...
//var_expected_rc = findTestData("Account/Get_Customer_Profile").getValue("expected_rc", 1)
//var_customer_token = findTestData("Account/Get_Customer_Profile").getValue("customer_token", 1)
...
def request = (RequestObject) findTestObject('E_Wallet/obj_getCustomerProfile')
