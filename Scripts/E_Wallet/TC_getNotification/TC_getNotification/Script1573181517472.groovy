...
//var_expected_rc = findTestData("E_Wallet/DF_getNotification/DF_getNotification").getValue("expected_rc", 1)
//var_customer_token = findTestData("E_Wallet/DF_getNotification/DF_getNotification").getValue("customer_token", 1)
...
def request = (RequestObject) findTestObject('E_Wallet/obj_getNotification')
