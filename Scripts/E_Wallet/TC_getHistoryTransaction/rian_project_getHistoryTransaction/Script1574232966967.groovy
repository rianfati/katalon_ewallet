...
//var_user_agent = findTestData("E_Wallet/DF_getHistoryTransaction/DF_getHistoryTransaction").getValue("user_agent", 1)
//var_wallet_id = findTestData("E_Wallet/DF_getHistoryTransaction/DF_getHistoryTransaction").getValue("wallet_id", 1)
//var_trx_type_id = findTestData("E_Wallet/DF_getHistoryTransaction/DF_getHistoryTransaction").getValue("trx_type_id", 1)
//var_start_time = findTestData("E_Wallet/DF_getHistoryTransaction/DF_getHistoryTransaction").getValue("start_time", 1)
//var_end_time = findTestData("E_Wallet/DF_getHistoryTransaction/DF_getHistoryTransaction").getValue("end_time", 1)
//var_organisation_id = findTestData("E_Wallet/DF_getHistoryTransaction/DF_getHistoryTransaction").getValue("organisation_id", 1)
//var_lang = findTestData("E_Wallet/DF_getHistoryTransaction/DF_getHistoryTransaction").getValue("lang", 1)
//var_expected_rc = findTestData("E_Wallet/DF_getHistoryTransaction/DF_getHistoryTransaction").getValue("expected_rc", 1)
//var_customer_token = findTestData("E_Wallet/DF_getHistoryTransaction/DF_getHistoryTransaction").getValue("customer_token", 1)
...
'"start_time":"' + GlobalVariable.start_time +'",'+
'"end_time":"' + GlobalVariable.end_time +
'"}'
...
def request = (RequestObject) findTestObject('E_Wallet/obj_getHistoryTransaction')
