...
//var_user_agent = findTestData("E_Wallet/DF_addSoF/DF_addSofKaspro").getValue("user_agent", 1)
//var_issuer_code = findTestData("E_Wallet/DF_addSoF/DF_addSofKaspro").getValue("issuer_code", 1)
//var_account_no_cid = findTestData("E_Wallet/DF_addSoF/DF_addSofKaspro").getValue("account_no_cid", 1)
...
def request = (RequestObject) findTestObject('E_Wallet/obj_addSofLinkAja')
