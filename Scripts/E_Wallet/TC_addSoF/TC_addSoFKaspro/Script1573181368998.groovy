...
var_enciphered_pin = SecureUtils.doEncryptPinRsaEwallet(GlobalVariable.dev_public_pem_file, var_enchipered_pin)
...
println (GlobalVariable.access_token_customer)
