...
//var_expected_rc = findTestData("E_Wallet/DF_getTransactionOverview/DF_getTransactionOverview").getValue("expected_rc", 1)
//var_customer_token = findTestData("E_Wallet/DF_getTransactionOverview/DF_getTransactionOverview").getValue("customer_token", 1)
...
def request = (RequestObject) findTestObject('E_Wallet/obj_getTransactionOverview')
