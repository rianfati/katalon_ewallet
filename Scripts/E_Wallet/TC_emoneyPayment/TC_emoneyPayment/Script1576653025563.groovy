...
String plain =   '{"user_agent":"'+var_user_agent+'","billing_id":"'+var_billing_id+'","wallet_id":"'+var_wallet_id+'","phone_number":"'+var_phone_number+'","authentication":"'+var_enciphered_pin+'"}'
