...
'"amount":"' + var_amount +'",'+
'"additional_data1":"' + var_additional_data1 +'",'+
'"additional_data2":"' + var_additional_data2 +'",'+
'"additional_data3":"' + var_additional_data3 +'",'+
'"expired_in":"' + var_expired_in +'",'+
...
def request = (RequestObject) findTestObject('E_Wallet/obj_generateQRPayment')
...
if (result == false) {
	...
	if (rc_ref == ReturnCodes.RC00) {
		...
		String filename = ('D:\\QR_Payment\\qr_temp_' + System.currentTimeMillis()) + '.png'
